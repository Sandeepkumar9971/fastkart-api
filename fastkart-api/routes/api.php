...
// Webhooks
Route::post('/paypal/webhook', 'App\Http\Controllers\WebhookController@paypal');
Route::post('/razorpay/webhook', 'App\Http\Controllers\WebhookController@razorpay');
Route::post('/stripe/webhook', 'App\Http\Controllers\WebhookController@stripe');
Route::post('/mollie/webhook', 'App\Http\Controllers\WebhookController@mollie');
