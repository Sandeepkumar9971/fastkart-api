        ...
        try {
            ...
            switch ($order->payment_method) {
                case PaymentMethod::PAYPAL:
                    return Paypal::paymentStatus($order, $transaction_id);

                case PaymentMethod::STRIPE:
                    return Stripe::paymentStatus($order, $transaction_id);

                case PaymentMethod::RAZORPAY:
                    return Razorpay::paymentStatus($order, $transaction_id);

                case PaymentMethod::MOLLIE:
                    return mollie::paymentStatus($order, $transaction_id);
            }
        ...
        try {
            ...
            switch ($request->payment_method) {
                ...
                case PaymentMethod::COD:
                    return Cod::paymentStatus($order, $request);
